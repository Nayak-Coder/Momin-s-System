  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-white min-h-screen">
      ...
      <section className="py-16 text-center">
        <h1 className="text-5xl font-extrabold text-blue-700 mb-4 drop-shadow-lg">Who We Are</h1>
        <p className="text-xl text-gray-700 max-w-2xl mx-auto">
          <span className="font-semibold text-blue-600">Momin's Tech Store</span> is where innovation meets passion. We’re not just a store—we’re a community of dreamers, builders, and tech lovers.
        </p>
      </section>
      ...
      <section className="flex flex-wrap justify-center gap-8 py-8">
        <div className="bg-white rounded-xl shadow-lg p-6 w-64 hover:scale-105 transition">
          <h2 className="text-2xl font-bold text-blue-600 mb-2">15+ Years</h2>
          <p className="text-gray-600">Delivering the latest gadgets since 2010.</p>
        </div>
        <div className="bg-white rounded-xl shadow-lg p-6 w-64 hover:scale-105 transition">
          <h2 className="text-2xl font-bold text-blue-600 mb-2">100K+ Customers</h2>
          <p className="text-gray-600">Trusted by tech enthusiasts nationwide.</p>
        </div>
        <div className="bg-white rounded-xl shadow-lg p-6 w-64 hover:scale-105 transition">
          <h2 className="text-2xl font-bold text-blue-600 mb-2">Award Winning</h2>
      ...
      <section className="max-w-3xl mx-auto py-12">
        <h2 className="text-3xl font-semibold text-center mb-8 text-blue-700">Our Journey</h2>
        <ol className="relative border-l-4 border-blue-200">
          <li className="mb-10 ml-6">
            ...
            <h3 className="font-bold text-lg text-blue-700">Founded</h3>
          ...
          <li className="mb-10 ml-6">
            ...
            <h3 className="font-bold text-lg text-blue-700">Nationwide Expansion</h3>
          ...
          <li className="ml-6">
            ...
            <h3 className="font-bold text-lg text-blue-700">Online Revolution</h3>
      ...
      <section className="py-12 bg-blue-50">
        <h2 className="text-3xl font-semibold text-center mb-8 text-blue-700">Meet Our Team</h2>
      ...
      <section className="py-12 text-center">
        <h2 className="text-2xl font-semibold mb-3 text-blue-700">Let’s Connect</h2>
        <p className="text-lg text-gray-700 mb-4">
          Have questions, ideas, or want to partner? <br />
          <a href="mailto:support@techstore.com" className="text-blue-600 font-semibold hover:underline">support@techstore.com</a>
        </p>
        <a
          href="/contact"
